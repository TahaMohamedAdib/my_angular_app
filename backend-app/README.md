...
```java
// src/main/java/com/zeineb/backendapp/entities/Product.java
@Entity
...
```java
// src/main/java/com/zeineb/backendapp/repositories/ProductRepository.java
...
```java
// src/main/java/com/zeineb/backendapp/web/ProductRestAPI.java
@RestController
@CrossOrigin("*")
@RequestMapping("/api")
@AllArgsConstructor
...
```java
// src/main/java/com/zeineb/backendapp/BackendAppApplication.java
@Bean
